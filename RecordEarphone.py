...
if __name__ == '__main__':
    ...
    # time1 = ["2021-01-31 04:09:05", "2021-01-31 12:00:00", "2021-01-31 18:00:05", "2021-01-31 23:50:09", "2021-02-01 03:00:00", "2021-02-01 19:00:00", "2021-02-01 22:09:00"]
    # time2 = ["7小时30分钟", "5小时21分钟", "4小时13分钟", "2小时40分钟", "14小时48分钟", "2小时30分钟",
    #          "6小时"]
    # json_d = {}
    # total_time = 0
    # json_d["time_ago"] = ""
    # for i in range(7):
    #     print(i, time1[i], time2[i])
    #     temp_time = remake_time_sec(time2[i])
    #     total_time += temp_time
    #     json_d[time1[i]] = temp_time
    # json_d["time_ago"] = total_time
    # print(total_time)
    # print(remake_time_human(total_time))
    # with open(record_path, 'w') as f:
    #     json.dump(json_d, f)
